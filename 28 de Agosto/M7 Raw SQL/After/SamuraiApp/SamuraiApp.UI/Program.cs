...
namespace SamuraiApp.UI
{
    class Program
    {
        ...
        {
            var text = "Happy";
            System.Collections.Generic.List<Domain.Samurai> samurais = _context.Samurais.FromSqlRaw(
             "EXEC dbo.SamuraisWhoSaidAWord {0}", text).AsEnumerable<Domain.Samurai>().ToList();
        }
