...
public class CourseLibraryContext : DbContext
{
    ...
    public DbSet<Author> Authors { get; set; } = null!; //Especificamos las tablas
    public DbSet<Course> Courses { get; set; } = null!;

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        // seed the database with dummy data
        modelBuilder.Entity<Author>().HasData(//pregntamos si tiene estos datos
            new Author("Berry", "Griffin Beak Eldritch", "Ships")
            {
                Id = Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"), //un guid concreto
